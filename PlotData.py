...
def plotPosition(event, CRP, info, path):
    ...
    # Save file
    file_name = 'Position_'+info[0]+'_'+info[1]
...
def plot2DAngle(event, CRP, info, path):
    ...
    # Save file
    file_name = 'Angle2D_'+info[0]+'_'+info[1]
    plt.savefig(os.path.join(path,file_name+'.pdf'), format='pdf')
    plt.savefig(os.path.join(path,file_name+'.png'), format='png')
    plt.close()
...
def plotDistance(event, CRP, info, path):
    ...
    # Save file
    file_name = 'Distance_'+info[0]+'_'+info[1]
    plt.savefig(os.path.join(path,file_name+'.pdf'), format='pdf')
    plt.savefig(os.path.join(path,file_name+'.png'), format='png')
    plt.close()
...
def plot1DAngle(event, CRP, info, path):
    ...
    # Save file
    file_name = 'Angle1D_'+info[0]+'_'+info[1]
    plt.savefig(os.path.join(path,file_name+'.pdf'), format='pdf')
    plt.savefig(os.path.join(path,file_name+'.png'), format='png')
    plt.close()
...
def plot2DVel(event, CRP, info, path):
    ...
    # Plot pupil position
    fig, (ax1, ax2) = plt.subplots(2,1,sharaex=True)
    ...
    # Save file
    file_name = 'Velocity2D_'+info[0]+'_'+info[1]
    plt.savefig(os.path.join(path,file_name+'.pdf'), format='pdf')
    plt.savefig(os.path.join(path,file_name+'.png'), format='png')
    plt.close()
...
def plot2DAVel(event, CRP, info, path):
    ...
    # Save file
    file_name = 'AVelocity2D_'+info[0]+'_'+info[1]
    plt.savefig(os.path.join(path,file_name+'.pdf'), format='pdf')
    plt.savefig(os.path.join(path,file_name+'.png'), format='png')
    plt.close()
...
def plot1DVel(event, CRP, info, path):
    ...
    # Save file
    file_name = 'Velocity1D_'+info[0]+'_'+info[1]
    plt.savefig(os.path.join(path,file_name+'.pdf'), format='pdf')
    plt.savefig(os.path.join(path,file_name+'.png'), format='png')
    plt.close()
...
def plot1DAVel(event, CRP, info, path):
    ...
    # Save file
    file_name = 'AVelocity1D_'+info[0]+'_'+info[1]
    plt.savefig(os.path.join(path,file_name+'.pdf'), format='pdf')
    plt.savefig(os.path.join(path,file_name+'.png'), format='png')
    plt.close()
...
def plotSize(event, CRP, info, path):
    ...
    # Plot pupil position
    ax = CRP.plot(x='Time', y='a_corr',label='r',title=title)
    ...
    # Save file
    file_name = 'Size_'+info[0]+'_'+info[1]
    plt.savefig(os.path.join(path,file_name+'.pdf'), format='pdf')
    plt.savefig(os.path.join(path,file_name+'.png'), format='png')
    plt.close()
...
def runEpoch(result_path):
    for filename in os.listdir(result_path):
        if filename.startswith('Epoch'):
            # Get epoch info
            event, CRP, epoch_info, path = loadInfo(result_path, filename)
...
if __name__ == '__main__':
    # Parameters
    main_path = r'C:\Users\HeLab\Documents\Ruijia\Project\EyeTracking\Data\v1\601-1339450-OKR'
    
    data_dir = 'OUT_INFO'
    data_path = os.path.join(main_path, data_dir)
    
    video_dir = 'OUT_VIDEO'
    video_file = 'RUN1_2020-01-19-13-34'
