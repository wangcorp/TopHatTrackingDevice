...
def plotDistance(event, CRP, freq, path):
    '''
        Plot distance of pupil the eye center
    '''
    # Get epoch title
...
def main(main_path, result_path, epoch_name):
    ...
    # Get epoch info
    event, CRP, mpu, freq, path = loadInfo(result_path, epoch_name)
...
if __name__ == '__main__':
    ...
    main_path = main_path[freq_select]
    result_path = result_path[freq_select]
